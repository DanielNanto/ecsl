...
//! \warning Please note that the 'str' argument will have memory allocated via
//! \warning malloc(), and as such will need to be free'd manually.
...
//! \warning Please note that the 'array' argument will have memory allocated via
//! \warning realloc(), and as such will need to be free'd manually.
